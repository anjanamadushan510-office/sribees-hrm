    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="mt-1 text-[13px] text-ink-soft">
          Live view of attendance, leave and headcount across Sribees.
        </p>
      </header>
            ...
            <div className="space-y-6">
              <section className="rounded-xl border border-line bg-surface p-5 shadow-card sm:p-6">
                ...
                <div className="mt-2 flex flex-wrap items-end gap-x-4 gap-y-2">
                  ...
                  <p className="pb-1.5 text-[13px] text-ink-soft">
                    {stats.activeToday} of{" "}
                    {Math.max(1, stats.headcount - stats.onLeaveToday)} expected
                    employees have clocked in
                  </p>
                </div>
              ...
              <Card>
                <CardHeader
                  ...
                  action={
                    <Badge tone="neutral">
                      {stats.avgHoursThisWeek}h avg / person this week
                    </Badge>
                  }
                />
                    ...
                    {stats.pendingQueue.map(({ request, employeeName }) => (
                      ...
                      >
                        ...
                        <p className="mt-0.5 text-[12px] text-ink-soft">
                          {LEAVE_TYPE_LABEL[request.type]} · {request.days} day
                          {request.days === 1 ? "" : "s"} ·{" "}
                    ...
                    <div key={row.department}>
                      ...
                      <div className="mt-1 h-1.5 w-full overflow-hidden rounded-full bg-canvas">
                        <div
                          ...
                          style={{
                            width: `${(row.count / Math.max(1, stats.headcount)) * 100}%`,
                          }}
                        />
                      </div>
                    </div>
